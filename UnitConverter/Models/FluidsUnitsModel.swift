...
enum FluidsUnitsCategory: String, CaseIterable, UnitCategory {
    ...
    private func convertVolumetricFlowRate(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        let cubicMeterPerSecondValues: [String: Decimal] = [
            ...
            "cm³/s": Decimal(sign: .plus, exponent: -6, significand: 1),
            ...
            "mL/s": Decimal(sign: .plus, exponent: -6, significand: 1),
        ...
        guard let fromValue = cubicMeterPerSecondValues[fromUnit], let toValue = cubicMeterPerSecondValues[toUnit] else {
            return value
        }
    ...
    private func convertMassFlowRate(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        let kilogramPerSecondValues: [String: Decimal] = [
            ...
            "cg/s": Decimal(sign: .plus, exponent: -5, significand: 1),
            "mg/s": Decimal(sign: .plus, exponent: -6, significand: 1),
            "µg/s": Decimal(sign: .plus, exponent: -9, significand: 1),
            "t/s": 1000,
        ...
        guard let fromValue = kilogramPerSecondValues[fromUnit], let toValue = kilogramPerSecondValues[toUnit] else {
            return value
        }
    ...
    private func convertMolarFlowRate(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        let molPerSecondValues: [String: Decimal] = [
            ...
            "dmol/s": Decimal(sign: .plus, exponent: -1, significand: 1),
            "cmol/s": Decimal(sign: .plus, exponent: -2, significand: 1),
            "mmol/s": Decimal(sign: .plus, exponent: -3, significand: 1),
            "µmol/s": Decimal(sign: .plus, exponent: -6, significand: 1),
            "nmol/s": Decimal(sign: .plus, exponent: -9, significand: 1),
            "pmol/s": Decimal(sign: .plus, exponent: -12, significand: 1),
            "fmol/s": Decimal(sign: .plus, exponent: -15, significand: 1),
            "amol/s": Decimal(sign: .plus, exponent: -18, significand: 1),
        ...
        guard let fromValue = molPerSecondValues[fromUnit], let toValue = molPerSecondValues[toUnit] else {
            return value
        }
    ...
    private func convertMassFlowRateDensity(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        ...
        guard let fromValue = gramPerSecondPerSquareMeterValues[fromUnit], let toValue = gramPerSecondPerSquareMeterValues[toUnit] else {
            return value
        }
    ...
    private func convertMolarConcentration(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        ...
        guard let fromValue = molPerCubicMeterValues[fromUnit], let toValue = molPerCubicMeterValues[toUnit] else {
            return value
        }
    ...
    private func convertDensity(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        ...
        guard let fromValue = kilogramPerLiterValues[fromUnit], let toValue = kilogramPerLiterValues[toUnit] else {
            return value
        }
    ...
    private func convertDynamicViscosity(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        let pascalSecondValues: [String: Decimal] = [
            ...
            "mP": Decimal(sign: .plus, exponent: -4, significand: 1),
            "µP": Decimal(sign: .plus, exponent: -7, significand: 1),
            "nP": Decimal(sign: .plus, exponent: -10, significand: 1),
            "pP": Decimal(sign: .plus, exponent: -13, significand: 1),
            "fP": Decimal(sign: .plus, exponent: -16, significand: 1),
            "aP": Decimal(sign: .plus, exponent: -19, significand: 1),
        ...
        guard let fromValue = pascalSecondValues[fromUnit], let toValue = pascalSecondValues[toUnit] else {
            return value
        }
    ...
    private func convertKinematicViscosity(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        let squareMeterPerSecondValues: [String: Decimal] = [
            ...
            "mm²/s": Decimal(sign: .plus, exponent: -6, significand: 1),
            ...
            "dSt": Decimal(sign: .plus, exponent: -5, significand: 1),
            "cSt": Decimal(sign: .plus, exponent: -6, significand: 1),
            "mSt": Decimal(sign: .plus, exponent: -7, significand: 1),
            "µSt": Decimal(sign: .plus, exponent: -10, significand: 1),
            "nSt": Decimal(sign: .plus, exponent: -13, significand: 1),
            "pSt": Decimal(sign: .plus, exponent: -16, significand: 1),
            "fSt": Decimal(sign: .plus, exponent: -19, significand: 1),
            "aSt": Decimal(sign: .plus, exponent: -22, significand: 1)
        ]
        
        guard let fromValue = squareMeterPerSecondValues[fromUnit], let toValue = squareMeterPerSecondValues[toUnit] else {
            return value
        }
    ...
    private func convertSurfaceTension(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        ...
        guard let fromValue = newtonPerMeterValues[fromUnit], let toValue = newtonPerMeterValues[toUnit] else {
            return value
        }
    ...
    private func convertPermeability(_ value: Decimal, from fromUnit: String, to toUnit: String) -> Decimal {
        ...
        guard let fromValue = kgPerPascalSecondSquareMeterValues[fromUnit], let toValue = kgPerPascalSecondSquareMeterValues[toUnit] else {
            return value
        }
